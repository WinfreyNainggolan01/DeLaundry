    ...
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-4xl w-full">
        ...
        <div class="flex flex-col md:flex-row">
            ...
            @if($complaint->image_public_id)
                <div class="md:w-1/2">
                    <x-cld-image alt="Complaint Image" class="rounded-lg mb-6 md:mb-0" height="400" public_id="{{ $complaint->image_public_id }}" width="600"></x-cld-image>
                </div>
            @else
                {{-- tambahkan pesan bahwa gambar tidak ada pada admin --}}
                <div class="md:w-1/2">
