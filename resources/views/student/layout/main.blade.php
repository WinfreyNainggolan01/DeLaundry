          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="flex items-baseline space-x-4 ml-10">
                ...
                <a href="/" class="{{ request()->is('/') ? "bg-gray-200 text-black" : "text-black hover:bg-gray-300 hover:text-sky-500"}} rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
