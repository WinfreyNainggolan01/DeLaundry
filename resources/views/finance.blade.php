...
<div class="min-h-full">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="flex items-baseline space-x-4 ml-10">
                ...
                <a href="/" class="{{ request()->is('/') ? "bg-gray-200 text-black" : "text-gray-300 hover:bg-gray-700 hover:text-white"}} rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Finance</a>
    ...
    <header class="bg-dark-blue shadow">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-100">FINANCE</h1>
      </div>
    </header>
        ...
        <section class="history">
            <div class="bg-white rounded-lg p-4 shadow-md">
                ...
                <table class="min-w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        <tr>
                            <td class="border-b p-2">April</td>
                            <td class="border-b p-2">Rp. 35,000</td>
                            <td class="border-b p-2">Unpaid</td>
                            <td class="border-b p-2">
                                <button class="bg-[#003366] text-white py-1 px-3 rounded hover:bg-[#002244]">VIEW</button>
                            </td>
                        </tr>
                        <tr>
                            <td class="border-b p-2">March</td>
                            <td class="border-b p-2">Rp. 45,000</td>
                            <td class="border-b p-2">Paid</td>
                            <td class="border-b p-2">
                                <button class="bg-[#003366] text-white py-1 px-3 rounded hover:bg-[#002244]">VIEW</button>
                            </td>
                        </tr>
                        <tr>
                            <td class="border-b p-2">February</td>
                            <td class="border-b p-2">Rp. 55,000</td>
                            <td class="border-b p-2">Paid</td>
                            <td class="border-b p-2">
                                <button class="bg-[#003366] text-white py-1 px-3 rounded hover:bg-[#002244]">VIEW</button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="border-b p-2">Rp. 37,000</td>
                            <td class="border-b p-2">Paid</td>
                            <td class="border-b p-2">
                                <button class="bg-[#003366] text-white py-1 px-3 rounded hover:bg-[#002244]">VIEW</button>
                            </td>
...
<footer class="bg-gray-900
  ...
  <div class="flex justify-center items-center space-x-1">
    <a href="#" data-tooltip-target="tooltip-facebook" class="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer dark:text-gray-200 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
        ...
        <span class="sr-only">Facebook123</span>
    </a>
